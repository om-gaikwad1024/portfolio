          ...
          <div className="flex flex-col">
            <div className="flex-1 border-b-[3px] border-black p-8 md:p-12 flex flex-col gap-8 ab-fadein-1">
              ...
              <div className="ab-fadein-2">
                ...
                <div>
                  {[
                    {role:'Software Developer Intern', company:'Cubiclogics', detail:'React · TypeScript · SharePoint Framework · Collaborative tooling', year:'2025'},
                    {role:'Enterprise App Developer', company:'Oneshell', detail:'React · Spring Boot · Full stack · Scalable enterprise systems', year:'2025'},
                  ].map((exp, i) => (
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 ab-fadein-3">
              {[
                {cat:'FRONTEND', items:'React · TypeScript · UI/UX'},
                {cat:'BACKEND', items:'Spring Boot · Python · REST'},
                {cat:'AI/ML', items:'ML · AI Agents · Analytics'},
                {cat:'ENTERPRISE', items:'SharePoint · Automation · Integration'},
              ].map(({cat, items}, i) => (
                <div
                  key={cat}
